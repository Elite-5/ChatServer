...
package Cygnus;
//this class is used to encrypt and decrypt IP Address of server , it uses a special algorithm to encrypt.
...
entry_decry(String id){
	...
	}}catch(Exception e) {JOptionPane.showMessageDialog(null,"Invalid Id/Connection to network failed.");//for invalid entry.
	re1="incorrect";}
}
public String convert() {
	
	return re1;//returning result of conversion.
}
}
